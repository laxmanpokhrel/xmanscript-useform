...
export type UseFormOutputType = {
    ...
    onSubmitHandler: (e: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement, MouseEvent>) => Promise<void>;
    setFormState: React.Dispatch<React.SetStateAction<formStateType>>;
    resetForm: () => void;
};
...
export type UpdateFormTouchedErrorsProps = {
    formName: string;
    update: Record<string, any>;
};
export type UpdateFormSandBoxObjectProps = {
    formName: string;
    sandBoxObject: ISandBoxObject;
};
...
export type AsyncSubmitHandlerFunction = (props: SubmitHandlerInputProps, sandBoxObject: ISandBoxObject) => Promise<void>;
export type SyncPrefillerFunction = () => Record<string, any>;
export type AsyncPrefillerFunction = () => Promise<Record<string, any>>;
export type FormProviderPropsType = {
...
type YupValidatorType = (validationSchema: Schema<any, any, any, ''>, values: Record<string, any>) => Promise<Record<string, any>>;
export type ValidateFormValuesProps = {
    validationSchema: Schema<any> | ((props: Record<string, unknown>) => Record<string, any>) | ((props: Record<string, unknown>, yupValidator?: YupValidatorType) => Promise<Record<string, any>>);
    values: Record<string, any>;
};
export {};
