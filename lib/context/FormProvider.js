...
const FormProvider = (formProviderProps) => {
    ...
    function initializeFormToContext(formName) {
        ...
        if (formNameCache.get(formName))
            throw new Error('Duclicate form name. Please add a unique form name.');
        else
    ...
    function updateFormErrors({ formName, update }) {
        setFormState(prev => (Object.assign(Object.assign({}, prev), { [formName]: Object.assign(Object.assign({}, prev[formName]), { errors: Object.assign(Object.assign({}, prev[formName].errors), update) }) })));
    }
    // function to handle update of the form touchedErrors
    function updateFormTouchedErrors({ formName, update }) {
        setFormState(prev => (Object.assign(Object.assign({}, prev), { [formName]: Object.assign(Object.assign({}, prev[formName]), { touchedErrors: Object.assign(Object.assign({}, prev[formName].touchedErrors), update) }) })));
    }
