...
function useDebouncedValidation({ callback, dependencies, validationSchema, values, debounceTime = 300, validateOnSubmit, }) {
    return React.useEffect(() => {
        ...
        const timerInstance = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            if (validationSchema) {
                const errorObject = yield (0, validateFormValues_1.default)({
                    validationSchema,
                    values,
                });
...
exports.default = useDebouncedValidation;
